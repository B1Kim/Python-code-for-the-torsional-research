...
webFrameDistance=stiffDistance*5/2
heightY=webFrameDistance*6*2
...
xForLongTrans = - widthX/2 + addDistance
longTransSketch.Line(point1=(xForLongTrans,- heightY/2),point2=(xForLongTrans, heightY/2))
...
import job
jobName = 'Code-'+str(int(thicknessOfDeck))+'-'+str(int(thicknessOfStiff))+'-'+str(int(depthOfWeb))+
        '-'+str(int(depthOfStiff))+'S4R'
