...
depthOfWeb=2400.0
depthOflongTrans=1200.0 ## the second stringers from 5 to 10
...
for X in range(31):     ## 23
    ...
    for Y in range(2):  ## 15
        ...
        massPositionY=(Y+5)*2*stiffDistance/3
        ...
        import job
        jobName = 'liftTask4-2'+'_'+'X'+str(int(massPositionX))+'_'+'Y'+str(int(massPositionY))
