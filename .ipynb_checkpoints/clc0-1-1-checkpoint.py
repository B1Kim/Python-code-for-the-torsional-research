...
massCoupleCoodination1=(0, webFrameDistance*1, 0.0)
massCoupleCoodination2=(0, -webFrameDistance*1, 0.0)
...
import job
jobName = 'Code-'+str(int(thicknessOfDeck))+'-'+str(int(thicknessOfStiff))+'-'+str(int(depthOfWeb))+'-'+str(int(depthOfStiff))+'-0-1-1'
