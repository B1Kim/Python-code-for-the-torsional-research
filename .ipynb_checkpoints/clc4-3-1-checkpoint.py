...
for X in range(31):     ## 23

    for Y in range(1):  ## 15
        import load
        Y=10
        massPositionX=X*stiffDistance/3
        massPositionY=Y*stiffDistance/2
        ...
        import job
        jobName = 'liftTask4-3-1'+'_'+'X'+str(int(massPositionX))+'_'+'Y'+str(int(massPositionY))
        ...
        dispDataOfUpperRight.append((massPositionX, massPositionY, 
        ...
        dispDataOfDownRight.append((massPositionX, massPositionY, 
                                    dispOfdownRightNode ))
